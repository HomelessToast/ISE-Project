// Minimal test script for the updated ISE engine
const { compute } = require('./compute');

// Test with minimal inputs - only what's needed for K15
const testInputs = {
  // Core inputs
...
console.log('Testing Updated ISE Engine...');
console.log('Inputs:', Object.keys(testInputs).length, 'inputs provided');
...
try {
  ...
  if (typeof result['Sheet1!K15'] === 'number' && !isNaN(result['Sheet1!K15'])) {
    ...
    console.log('Engine computed', Object.keys(result).length, 'nodes');
  } else {
